function lyrics(){
    ...
    document.getElementById("main").innerHTML+="<br />1 bottle of beer on the wall, 1 bottle of beer<br />Take one down and pass it around, no more bottles of beer on the wall<br />";
